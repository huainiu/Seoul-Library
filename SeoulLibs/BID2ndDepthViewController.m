...
@interface BID2ndDepthViewController ()
...
@implementation BID2ndDepthViewController
...
- (void)viewDidLoad
{
    ...
    self.title = [NSString stringWithFormat:@"%@", [[NSUserDefaults standardUserDefaults] stringForKey:@"guName"]];
